...
class RecommendationAdapter(context: Context, width: Int) :
    RecyclerView.Adapter<RecommendationAdapter.MovieVH>() {
    ...
    inner class MovieVH(private val binding: ItemMovieBinding) :
        ...
        fun bind(movie: Movie) {
            ...
            movie.poster_path?.let { setImg(it) }
        ...
        override fun onClick(view: View?) {
            ...
            movieInfo.click(position = adapterPosition)
        }
